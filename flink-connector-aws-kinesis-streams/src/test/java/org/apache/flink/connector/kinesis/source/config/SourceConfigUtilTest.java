...
class SourceConfigUtilTest {
    ...
    void testParseStreamTimestampUsingDefaultFormat() throws Exception {
        ...
        assertThat(SourceConfigUtil.parseStreamTimestampStartingPosition(consumerProperties))
    ...
    void testParseStreamTimestampParseError() {
        ...
        assertThatExceptionOfType(NumberFormatException.class)
                .isThrownBy(
                        () ->
                                SourceConfigUtil.parseStreamTimestampStartingPosition(
                                        consumerProperties));
    }
