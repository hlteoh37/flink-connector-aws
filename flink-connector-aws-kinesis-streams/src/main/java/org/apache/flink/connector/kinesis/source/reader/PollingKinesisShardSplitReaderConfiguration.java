...
/**
 * A configuration class for {@link PollingKinesisShardSplitReader} instantiated from a properties
 * map.
 */
@Internal
    ...
    public PollingKinesisShardSplitReaderConfiguration(final Properties consumerConfig) {
        ...
        this.adaptiveReads =
                Boolean.parseBoolean(
                        consumerConfig.getProperty(
                                KinesisStreamsSourceConfigConstants.SHARD_USE_ADAPTIVE_READS,
                                Boolean.toString(
                                        KinesisStreamsSourceConfigConstants
